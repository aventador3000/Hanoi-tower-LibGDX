...
public class XMLparse {
    public Array<String> XMLparseLevels() {
        ...
        if (Gdx.app.getType() == Application.ApplicationType.Android) {
            ...
            dirHandle = Gdx.files.internal("xml/levels");
           dirHandle = Gdx.files.internal("xml/levels"); // хак для desktop проекта, так как он почему-то не видел этих файлов. Создайте символическую ссылку папки assets в в корне desktop-проекта на папку assets android-проекта
        }
